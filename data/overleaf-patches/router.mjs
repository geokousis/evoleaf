...
import TexPackageInstallerController from './Features/ServerAdmin/TexPackageInstallerController.mjs'
import PublicRegisterController from './Features/User/PublicRegisterController.mjs'
...
async function initialize(webRouter, privateApiRouter, publicApiRouter) {
  ...
  if (Features.hasFeature('registration-page')) {
    webRouter.get('/register', PublicRegisterController.renderRegisterPage)
    webRouter.post('/register', PublicRegisterController.register)
  ...
  webRouter.get(
    '/install',
    AuthenticationController.requireLogin(),
    TexPackageInstallerController.renderInstallPage
  )
  webRouter.post(
    '/install/api/jobs',
    AuthenticationController.requireLogin(),
    TexPackageInstallerController.createInstallJob
  )
  webRouter.get(
    '/install/api/jobs/:jobId',
    AuthenticationController.requireLogin(),
    TexPackageInstallerController.getInstallJob
  )
  webRouter.get(
    '/install/api/jobs/:jobId/events',
    AuthenticationController.requireLogin(),
    TexPackageInstallerController.streamInstallJobEvents
  )
  webRouter.post(
    '/project/new',
    AuthenticationController.requireLogin(),
